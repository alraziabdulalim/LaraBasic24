...
<body>
    ...
    <div class="container mx-auto">
        ...
        <main class="py-6">
            <h1 class="text-center font-bold text-2x1 mb-6">Product Show</h1>
                        ...
                        <div class="overflow-hidden">
                            <table class="min-w-full text-left text-sm font-light">
                                <tr class="border-b dark:border-neutral-500">
                                    <th scope="col" class="font-medium px-6 py-4">#</th>
                                    <td class="whitespace-nowrap px-6 py-4 font-medium">{{ $product->id }}</td>
                                </tr>
                                <tr class="border-b dark:border-neutral-500">
                                    <th scope="col" class="font-medium px-6 py-4">Product Name</th>
                                    <td class="whitespace-nowrap px-6 py-4">{{ $product->title }}</td>
                                </tr>
                                <tr class="border-b dark:border-neutral-500">
                                    <th scope="col" class="font-medium px-6 py-4">Product Price</th>
                                    <td class="whitespace-nowrap px-6 py-4">{{ $product->price }}</td>
                                </tr>
                                <tr class="border-b dark:border-neutral-500">
                                    <th scope="col" class="font-medium px-6 py-4">Action</th>
