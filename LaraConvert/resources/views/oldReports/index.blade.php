        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-white-400-900">
                    ...
                    <div class="p-6 max-w-3xl text-black border-b dark:bg-gray-800 dark:border-gray-700 shadow-md sm:rounded-lg mb-5">
                        ...
                        <table class="w-full text-sm text-left rtl:text-right text-white-500 dark:text-white-400">
                            ...
                            <tbody>
                                ...
                                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                    <td class="px-6 py-4 font-medium text-white-500 whitespace-nowrap dark:text-white">
