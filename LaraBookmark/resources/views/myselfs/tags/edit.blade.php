                ...
                <div class="p-6 text-black border-b dark:bg-gray-400 dark:border-gray-700">
                    ...
                    <form method="POST" action="{{ route('tags.update', $tag) }}">
                        ...
                        <div class="mt-5">
                            ...
                            <textarea id="description" name="description" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" required autofocus autocomplete="description">{{ $tag->description }}</textarea>
