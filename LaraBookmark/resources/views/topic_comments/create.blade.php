            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-black border-b dark:bg-gray-400 dark:border-gray-700">
                    ...
                    <form method="POST" action="{{ route('topic_comments.store', $topic) }}">
                        ...
                        <div>
                            <x-text-input id="topic_id" class="block mt-1 w-full" type="hidden" name="topic_id" :value="$topic->id" required autofocus autocomplete="topic_id" />
                        </div>
